...
void CreateWarehouseWindow(int x, int y, int** grid) {
    ...
    Robot robots[] = {
        CreateRobot(2, 0, 0, 17, 21, x, y, MODEL_GREEDY),
        CreateRobot(3, 26, 27, 14, 12, x, y, MODEL_GREEDY),
        CreateRobot(4, 3, 21, 26, 5, x, y, MODEL_BFS),
        CreateRobot(5, 9, 6, 26, 24, x, y, MODEL_BFS),
        CreateRobot(6, 26, 2, 9, 24, x, y, MODEL_ASTAR),
        CreateRobot(7, 3, 5, 20, 22, x, y, MODEL_ASTAR)
    };
